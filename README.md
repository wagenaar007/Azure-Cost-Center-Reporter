...
> Cost transparency for Azure Subscriptions – daily reports as Excel dashboards or interactive HTML reports.
...
- **Daily granularity** – costs per day, week, month and year
...
- **Excel dashboard** – multiple sheets (daily, weekly, monthly, resources)
...
```powershell
.\build_exe.ps1
# EXE liegt danach unter dist\CostCenter.exe
```
